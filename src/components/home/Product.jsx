            ...
            <div className="min-w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow-2xl dark:bg-gray-500 dark:border-gray-700">
                ...
                <div className="px-5 pb-5">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <a href="#" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Detallara bax</a>
                    </div>
                </div>
            </div>
        </div>
